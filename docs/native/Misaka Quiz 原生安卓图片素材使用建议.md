# Misaka Quiz 原生安卓图片素材使用建议

> 本文用于整理 Misaka Quiz 原生 Android / Compose 版本的图片素材接入建议。  
...
这样可以让原生 Android 版既有 Misaka Quiz 的角色识别度，又保持正式 App 的干净、稳定和流畅。
