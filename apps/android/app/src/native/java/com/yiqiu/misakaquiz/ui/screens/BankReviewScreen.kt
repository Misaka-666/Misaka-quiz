    ...
    GlassCard {
        ...
        indices.take(12).forEach { index ->
            ...
            Surface(
                ...
                color = if (index == currentIndex) MisakaColors.BrandPrimarySoft else Color.White.copy(alpha = 0.72f),
                border = BorderStroke(
                    1.dp,
...
private fun ReviewTypeChip(
    ...
    Surface(
        ...
        color = if (selected) MisakaColors.BrandPrimarySoft else Color.White.copy(alpha = 0.72f),
        border = BorderStroke(1.dp, if (selected) MisakaColors.LineSelected else MisakaColors.LineStrong)
    ) {
        Text(
            text = text,
...
private fun ReviewCompactButton(
    ...
    Surface(
        ...
        border = if (primary) null else BorderStroke(1.dp, MisakaColors.LineStrong)
    ) {
        Row(
