...
fun MeScreen(
    ...
    Column(
        ...
        Column(modifier = Modifier.fillMaxWidth()) {
            ...
            Spacer(Modifier.height(MisakaSpacing.Sm))
            Row(
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                DataActionTile(
                    ...
                    onClick = {
                        ...
                        createDocumentLauncher.launch("misaka_full_backup_${backupTimeStamp()}.zip")
                    }
                )
                DataActionTile(
        ...
        BankExportDialog(
            ...
            onExport = {
                if (selectedBankIds.isEmpty()) {
                    ...
                    createDocumentLauncher.launch("misaka_selected_banks_${backupTimeStamp()}.zip")
                }
...
private fun DataActionTile(
    ...
    Surface(
        ...
        border = BorderStroke(MisakaDimens.Hairline, if (warning) MisakaColors.StateWarningSoft else MisakaColors.LineSoft)
    ) {
        Column(
            ...
            Icon(
                ...
                tint = if (warning) MisakaColors.IconWarning else MaterialTheme.colorScheme.primary,
...
fun AppearancePreferenceScreen(
    ...
    Column(
        ...
        MisakaHeader(
            kicker = "Appearance",
            title = "外观偏好",
            subtitle = "管理主题、Misaka 模式、开屏图和应用图标。"
        )
        ...
        GlassCard {
            ...
            PreferenceSwitchRow(
                title = "Misaka 模式",
                desc = "显示开屏图、页面插画并切换 Misaka 图标。",
                checked = QuizRepository.misakaModeEnabled,
                onCheckedChange = { enabled -> QuizRepository.setMisakaModeEnabled(context, enabled) }
            )
...
private fun AiSettingsPanel(context: Context) {
    ...
    GlassCard {
        ...
        Spacer(Modifier.height(12.dp))
        Row(horizontalArrangement = Arrangement.spacedBy(MisakaSpacing.Sm)) {
            TextButton(
                onClick = {
...
private fun ThemeChoiceRow(
    ...
    Row(
        modifier = Modifier.fillMaxWidth(),
        horizontalArrangement = Arrangement.spacedBy(MisakaSpacing.Sm)
    ) {
        ThemeChoiceTile(
...
private fun ThemeChoiceTile(
    ...
    Surface(
        ...
        color = if (selected) MisakaColors.BrandPrimarySoft else MisakaColors.CardWhite78,
...
private fun PreferenceSwitchRow(
    ...
    Row(
        modifier = Modifier
            .fillMaxWidth()
            .misakaNoRippleClickable { onCheckedChange(!checked) }
            .padding(vertical = 4.dp),
        verticalAlignment = Alignment.CenterVertically
    ) {
        Icon(
