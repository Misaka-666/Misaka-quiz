...
import com.yiqiu.misakaquiz.state.QuestionSearchEngine
import com.yiqiu.misakaquiz.state.QuestionSearchMatchedField
import com.yiqiu.misakaquiz.state.QuestionSearchResult
import com.yiqiu.misakaquiz.state.QuestionSearchScope
    ...
    Column(
        ...
        GlassCard(contentPadding = 16.dp) {
            Text(
                ...
                color = MisakaColors.TextSecondary,
            ...
            Surface(
                modifier = Modifier
                    .fillMaxWidth()
                    .misakaNoRippleClickable { showScopeDialog = true },
                shape = androidx.compose.foundation.shape.RoundedCornerShape(MisakaRadius.Md),
                color = MisakaColors.CardWhite86,
                border = BorderStroke(1.dp, MisakaColors.LineStrong)
            ) {
                Row(
...
private fun SearchScopeOption(
    ...
    Surface(
        ...
        shape = androidx.compose.foundation.shape.RoundedCornerShape(MisakaRadius.Md),
        color = if (selected) MisakaColors.BrandPrimarySoft else Color.Transparent,
        border = BorderStroke(1.dp, if (selected) MisakaColors.LineSelected else MisakaColors.LineSoft)
    ) {
        Row(
...
private fun QuestionSearchResultCard(
    ...
    GlassCard(
        modifier = Modifier.misakaNoRippleClickable(onClick = onToggleExpanded),
        ...
        if (expanded) {
            Spacer(Modifier.height(12.dp))
            HorizontalDivider(color = MisakaColors.LineSoft)
            Spacer(Modifier.height(12.dp))
