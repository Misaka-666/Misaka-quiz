...
private fun QuestionImagePreview(
    ...
    Surface(
        ...
        border = androidx.compose.foundation.BorderStroke(1.dp, MisakaColors.LineStrong)
    ) {
            ...
            if (bitmap == null) {
                ...
                Image(
                    ...
                    modifier = Modifier
                        ...
                        .misakaNoRippleClickable { expanded = true },
            ...
            Surface(
                ...
                Box(
                    modifier = Modifier
                        ...
                        .misakaNoRippleClickable { expanded = false }
                        .padding(12.dp),
                    contentAlignment = Alignment.Center
                ) {
                    Image(
