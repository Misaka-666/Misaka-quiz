...
function setupSidebarCollapse(){
  ...
  if(localStorage.getItem('shiroha-sidebar-collapsed')!==null){localStorage.setItem('misaka-sidebar-collapsed',stored?'1':'0');localStorage.removeItem('shiroha-sidebar-collapsed')}
